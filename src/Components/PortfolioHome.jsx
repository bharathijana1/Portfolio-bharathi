...
const PortfolioHome = () => {
  ...
  return (
    <div className=''>
        <div className=' flex flex-col-reverse md:flex-row lg:flex-row justify-around items-center mx-auto lg:mx-5 lg:py-5 lg:h-screen'>
            ...
            <div className='flex justify-center item-center flex-col lg:flex-row mt-5'>
       ...
       <button className='border bg-fuchsia-900 p-2 px-8 py-3 m-2 text-lg font-medium text-white' 
            ...
            <div className='p-3 md:p-2 w-full xl:w-1/2 '>
